...
if (!empty($start_date)) {
    $sales_stmt->bindValue(':start_date', $start_date . ' 00:00:00');
}

if (!empty($end_date)) {
    $sales_stmt->bindValue(':end_date', $end_date . ' 23:59:59');
}
...
foreach ($sales as $sale) {
    // Ensure the total is numeric and not null
    if (is_numeric($sale['total'])) {
