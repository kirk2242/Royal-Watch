            ...
            <div class="tables-container">
                <div class="table-card">
                    <div class="table-header">
                        ...
                        <a href="manage_users.php" class="view-all">View All <i class="fas fa-arrow-right"></i></a>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="view_user.php?id=<?php echo $user['id']; ?>" title="View"><i class="fas fa-eye"></i></a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                ...
                <div class="table-card">
                    <div class="table-header">
                        ...
                        <a href="manage_products.php" class="view-all">View All <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div class="table-responsive">
                        <table>
                            <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit_product.php?id=<?php echo $product['id']; ?>" title="Edit"><i class="fas fa-edit"></i></a>
                                        <a href="view_product.php?id=<?php echo $product['id']; ?>" title="View"><i class="fas fa-eye"></i></a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
