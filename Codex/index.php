...
<body>
    ...
    <header id="header">
        ...
        <nav class="nav-links" id="navLinks">
            ...
            <a href="/auth/login.php" class="cta-button" style="background-color: blue;">Login</a>
        </nav>
    </header>
...
<section class="brands" id="brands">
        ...
        <div class="watch-container">
            ...
            <div class="watch-details">
                ...
                <div class="watch-price">
                    ...
                    <a href="#" class="cta-button"><i class="fas fa-shopping-cart"></i> Pre-Order</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="testimonials" id="testimonials">
        <div class="section-title">
            ...
            <p>What our discerning customers say about their Time Emporium experience.</p>
        </div>
        <div class="testimonial-slider">
            <div class="testimonial-slide active">
                <div class="testimonial-content">
                    The attention to detail and customer service at Time Emporium is unmatched. My Patek Philippe arrived perfectly authenticated and beautifully packaged. A truly premium experience.
                </div>
                <div class="testimonial-author">
                    <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="James Wilson" class="author-avatar">
                    <div class="author-info">
                        <h4>James Wilson</h4>
                        <p>Collector Since 2015</p>
                    </div>
                </div>
            </div>
            <div class="testimonial-slide">
                <div class="testimonial-content">
                    As a first-time luxury watch buyer, I appreciated the knowledgeable staff who guided me through the process without pressure. My Rolex Datejust is my most treasured possession.
                </div>
                <div class="testimonial-author">
    ...
    <footer id="contact">
        <div class="footer-content">
            ...
            <div class="footer-column">
                <h3>Contact</h3>
                <p><i class="fas fa-map-marker-alt"></i>Poblacion, Liloan, Cebu</p>
        ...
        <div class="footer-bottom">
            <p>&copy; 2023 Time Emporium. All rights reserved. | <a href="#">Privacy Policy</a> | <a href="#">Terms</a> | <a href="#">Authenticity Guarantee</a></p>
        </div>
    </footer>

    <script src="/assets/js/script.js"></script> <!-- Corrected path -->
</body>
</html>