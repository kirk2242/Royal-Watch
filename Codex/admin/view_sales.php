...
<body>
    ...
    <script>
        ...
        function viewSaleDetails(saleId) {
            ...
            // In a real implementation, you would load the details via AJAX
            // For now, we'll just show a placeholder
            content.innerHTML = `
                <div class="sale-details">
                    <div class="sale-details-row">
                        <div class="sale-details-label">Sale ID:</div>
                        <div class="sale-details-value">${saleId}</div>
                    </div>
                    <div class="sale-details-row">
                        <div class="sale-details-label">Date:</div>
                        <div class="sale-details-value">Sample Date</div>
                    </div>
                    <div class="sale-details-row">
                        <div class="sale-details-label">Cashier:</div>
                        <div class="sale-details-value">Sample User</div>
                    </div>
                    <div class="sale-details-row">
                        <div class="sale-details-label">Total:</div>
                        <div class="sale-details-value">₱0.00</div>
                    </div>
                </div>
                ...
                <div class="sale-items">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td colspan="4">No items available for this sale.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
