...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        // Insert into sales table with total amount
        $stmt = $pdo->prepare("INSERT INTO sales (user_id, payment_method, total, created_at) VALUES (?, ?, ?, NOW())");
        $stmt->execute([$validUserId, $paymentMethod, $totalAmount]);
